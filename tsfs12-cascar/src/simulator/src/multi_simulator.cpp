...
public:
  CascarSimulator() : Node("cascar_simulator"), count_(0) {
    ...
    steer_publisher_ = this->create_publisher<cascar_msgs::msg::SteeringAngle>(
        "steering_angle", 1);

    // Subscribers
    ctrl_subscription_ =
        this->create_subscription<cascar_msgs::msg::ControlRequest>(
            "control", 1,
            std::bind(&CascarSimulator::controlCallback, this, _1));
    lat_ctrl_subscription_ =
        this->create_subscription<cascar_msgs::msg::ControlRequest>(
            "lat_control", 1,
            std::bind(&CascarSimulator::latControlCallback, this, _1));
    lon_ctrl_subscription_ =
        this->create_subscription<cascar_msgs::msg::ControlRequest>(
            "lon_control", 1,
            std::bind(&CascarSimulator::lonControlCallback, this, _1));
    ...
    timer_ = this->create_wall_timer(
        10ms, std::bind(&CascarSimulator::timerCallback, this));
  }
...
private:
  ...
  void
  latControlCallback(const cascar_msgs::msg::ControlRequest::SharedPtr msg) {
    this->d_f = msg->df;
  }
  void
  lonControlCallback(const cascar_msgs::msg::ControlRequest::SharedPtr msg) {
    this->a_x = msg->ax;
  }
  ...
  rclcpp::Subscription<cascar_msgs::msg::ControlRequest>::SharedPtr
      ctrl_subscription_;
  rclcpp::Subscription<cascar_msgs::msg::ControlRequest>::SharedPtr
      lat_ctrl_subscription_;
  rclcpp::Subscription<cascar_msgs::msg::ControlRequest>::SharedPtr
  ...
  rclcpp::Publisher<cascar_msgs::msg::SteeringAngle>::SharedPtr
      steer_publisher_;
